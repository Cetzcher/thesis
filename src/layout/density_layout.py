...
class DensityLayout(HeightMapLayout):
    ...
    def layout(self) -> dict:
        ...
        for this layout we use the circle() function with linear interpolation
        that means that points at distnace d of the center will have a value of
        probability * 1/(d + 1).
